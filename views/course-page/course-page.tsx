...
const CoursePage = ({training, similarCourses}: CoursePageProps): ReactElement | null => {
  ...
  return (
    <>
      ...
      {forWhom && <ForWhom
        content={`
        <p>Данная программа повышения квалификации предназначена для специалистов, имеющих высшее медицинское
          образование и подготовку в ординатуре.</p>
        <p>По специальности “Стоматология ортопедическая” или профессиональная переподготовка по
          направлению “Стоматология ортопедическая” при наличии ординатуры по одной из специальностей: «Стоматология
          общей практики», «Стоматология» и работающих на должностях: врач стоматолог-ортопед, заведующий (начальник)
          структурного подразделения (отдела, отделения, лаборатории, кабинета, отряда и другое) медицинской
          организации.</p>
        <h3>Одобрено образовательной организацией</h3>
        <p>Программа повышения квалификации разработана и утверждена образовательной организацией с учетом требований
          рынка труда и требований, предъявляемых к дополнительному профессиональному образованию
          в соответствии с основными нормативно-правовыми документами РФ.</p>
        <table>
          <thead>
            <tr>
              <td>Выбор тактики лечения </td>
              <td>Выбор тактики лечения </td>
              <td>Выбор тактики лечения </td>
              <td>Выбор тактики лечения </td>
            </tr>
        ...
        <ul>
          <li>Выбор тактики лечения в сложных клинических случаях</li>
          <li>Выбор тактики лечения в сложных клинических случаях</li>
          <li>Выбор тактики лечения в сложных клинических случаях</li>
        </ul>
        <ol>
        ...
        <p>По специальности “Стоматология ортопедическая” или профессиональная переподготовка по направлению
          “Стоматология ортопедическая” при наличии ординатуры по одной из специальностей: «Стоматология общей
          практики», «Стоматология» и работающих на должностях: врач стоматолог-ортопед, заведующий (начальник)
          структурного подразделения (отдела, отделения, лаборатории, кабинета, отряда и другое) медицинской
          организации.</p>
        <p class="accent">Данная программа повышения квалификации предназначена для специалистов, имеющих высшее медицинское образование и подготовку в ординатуре.</p>
        <ol class="default">
          <li>Выбор тактики лечения в сложных клинических случаях</li>
          <li>Выбор тактики лечения в сложных клинических случаях</li>
          <li>Выбор тактики лечения в сложных клинических случаях</li>
