...
const Top = ({title, titles, description, type, promoImage, date, course}: TopProps): ReactElement | null => {
  return (
    <div className={styles.wrapper}>
      ...
      {course && <CourseShortItem course={course} withPhoto={false} background={"white"} />}
      {promoImage &&
