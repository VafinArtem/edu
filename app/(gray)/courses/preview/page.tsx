...
import Promo from "@/app/(gray)/courses/components/promo/promo";
import Advantages from "@/app/(gray)/courses/components/advantages/advantages";
import Program from "@/app/(gray)/courses/components/program/program";
import Speakers from "@/app/(gray)/courses/components/speakers/speakers";
import RecordForm from "@/app/(gray)/courses/components/record-form/record-form";
import Schedule from "@/app/(gray)/courses/components/schedule/schedule";
import Price from "@/app/(gray)/courses/components/price/price";
import Certificate from "@/components/_common/certificate/certificate";
import Gallery from "@/app/(gray)/courses/components/gallery/gallery";
...
import Faq from "@/app/(gray)/courses/components/faq/faq";
import SpeakerCourses from "@/app/(gray)/courses/components/speaker-courses/speaker-courses";
import PromoRegistration from "@/components/_common/promo-registration/promo-registration";
import Location from "@/app/(gray)/courses/components/location/location";
  ...
  return (
    <>
      ...
      <div className="container">
        <Certificate courseTypeName={`мастер-класса`} />
      </div>
