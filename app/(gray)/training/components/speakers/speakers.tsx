...
import SpeakerItem from "@/components/_training/speaker-item/speaker-item";

const Speakers = ({className, speakers}: SpeakersProps): ReactElement | null => {
  return (
		<SectionItem className={className}>
			<SectionCenterHead>
				<Heading tag={`h2`}>Ведут мастер-класс</Heading>
			</SectionCenterHead>
