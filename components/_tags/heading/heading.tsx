...
const Heading = ({
  ...
  switch (tag) {
    case "h1":
      return <h1 className={clsx(classNameOptions)} {...props}>{children}</h1>;
    case "h2":
      return <h2 className={clsx(classNameOptions)} {...props}>{children}</h2>;
    case "h3":
      return <h3 className={clsx(classNameOptions)} {...props}>{children}</h3>;
    case "h4":
      return <h3 className={clsx(classNameOptions)} {...props}>{children}</h3>;
    case "h5":
      return <h3 className={clsx(classNameOptions)} {...props}>{children}</h3>;
